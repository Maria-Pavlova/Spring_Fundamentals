--INSERT INTO users (id, email, password, first_name, last_name, is_active, image_url, created, modified)
--VALUES (1, 'ivan@abv.bg', 'somepass', 'Ivan', 'Ivanov', 1 , 'resources/static/img/1.jpg', null, null) ;
--
--INSERT INTO users (id, email, password, first_name, last_name, is_active, image_url, created, modified)
--VALUES (2, 'Peter@abv.bg', 'somepass2', 'Peter', 'Petrov', 1 , 'resources/static/img/1.jpg', null, null) ;
...
INSERT INTO offers(created, engine, imageUrl, mileage, price, trnsmission, year, seller_id, model_id)
VALUES('2023-01-16', 'DIESEL', 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/2015_BMW_M4_%28F82%29_coupe_%2824220553394%29.jpg/560px-2015_BMW_M4_%28F82%29_coupe_%2824220553394%29.jpg', 140000, 35000, 'AUTOMATIC', 2012, 1, 1);